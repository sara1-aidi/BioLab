...
// Import SphereGeometry directly from three
import { SphereGeometry } from 'three'; // Change here to SphereGeometry
...
export default function Scene({ setBg }) {
  ...
  // Move useFrame logic here to animate sphere and light based on mouse position
  useFrame((state) => {
